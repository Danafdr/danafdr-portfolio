...
export default function About() {
  return (
    <section id="about-s" className="grid grid-cols-1 lg:grid-cols-2 border-b border-border-rgba reveal">
      <div className="py-[52px] px-6 md:px-12 border-b lg:border-b-0 lg:border-r border-border-rgba">
        ...
        <p className="text-[13px] leading-relaxed font-sans md:font-mono md:text-[11px] text-ink2 md:leading-[1.95]">
      ...
      <div className="py-[52px] px-6 md:px-12">
        <h2 className="font-playfair text-[24px] md:text-[30px] lg:text-[36px] font-black leading-[0.95] tracking-[-0.02em] mb-7">What<br /><em className="italic font-normal text-ink2">shapes him</em></h2>
        <div className="flex flex-col">
          <div className="py-4 border-b border-border-rgba grid grid-cols-[22px_1fr] gap-[14px] last:border-b-0">
            ...
            <div>
              ...
              <div className="text-[13px] leading-relaxed font-sans md:font-mono md:text-[10px] text-ink2 md:leading-[1.7]">People consumed by making things perfectly. Craft obsession, emotional beauty, vivid chaos — all four in the same room.</div>
            </div>
          </div>
          <div className="py-4 border-b border-border-rgba grid grid-cols-[22px_1fr] gap-[14px] last:border-b-0">
            ...
            <div>
              ...
              <div className="text-[13px] leading-relaxed font-sans md:font-mono md:text-[10px] text-ink2 md:leading-[1.7]">Brutal white space. Raw newsprint. Things placed wrong on purpose. Emotion without explanation. The visual language of this portfolio.</div>
            </div>
          </div>
          <div className="py-4 border-b border-border-rgba grid grid-cols-[22px_1fr] gap-[14px] last:border-b-0">
            ...
            <div>
              ...
              <div className="text-[13px] leading-relaxed font-sans md:font-mono md:text-[10px] text-ink2 md:leading-[1.7]">Layers, wear, texture. Stickers over stickers. Nothing great looks like it was made in five minutes.</div>
            </div>
          </div>
          <div className="py-4 border-b border-border-rgba grid grid-cols-[22px_1fr] gap-[14px] last:border-b-0">
            ...
            <div>
              ...
              <div className="text-[13px] leading-relaxed font-sans md:font-mono md:text-[10px] text-ink2 md:leading-[1.7]">A lone bird over open ocean. A chapel glimpsed through dense forest. One point of light in a vast dark world. Real camera when the budget allows.</div>
            </div>
          </div>
        </div>
      </div>
