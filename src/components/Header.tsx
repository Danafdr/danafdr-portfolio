...
export default function Header() {
  ...
  return (
    <header className={`px-6 md:px-12 border-b border-border-rgba flex flex-col md:grid md:grid-cols-[1fr_auto_1fr] items-center gap-2 md:gap-5 relative md:sticky md:top-0 z-[100] bg-paper/96 backdrop-blur-[10px] transition-transform duration-300 ease-in-out ${isVisible ? "translate-y-0" : "-translate-y-full"}`}>
