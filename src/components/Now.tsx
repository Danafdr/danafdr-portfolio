  ...
  return (
    <section id="now" className="grid grid-cols-1 md:grid-cols-3 border-b border-border-rgba reveal">
      <div className="py-8 px-5 md:px-7 border-b md:border-b-0 md:border-r border-border-rgba md:last:border-r-0">
        ...
        <div className="font-playfair text-[16px] md:text-[19px] lg:text-[22px] font-black leading-[1.1] tracking-[-0.01em] mb-[10px]">Shipping web apps</div>
      ...
      <div className="py-8 px-5 md:px-7 border-b md:border-b-0 md:border-r border-border-rgba md:last:border-r-0">
        ...
        <div className="font-playfair text-[16px] md:text-[19px] lg:text-[22px] font-black leading-[1.1] tracking-[-0.01em] mb-[10px]">Cinematography &amp; SaaS motion</div>
      ...
      <div className="py-8 px-5 md:px-7 md:border-r border-border-rgba md:last:border-r-0">
        ...
        <div className="font-playfair text-[16px] md:text-[19px] lg:text-[22px] font-black leading-[1.1] tracking-[-0.01em] mb-[10px]">Blonde — Frank Ocean</div>
